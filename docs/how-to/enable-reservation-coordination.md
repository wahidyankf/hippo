...
rejects this flag with exit `2`, under schema 2 as under schema 3, and uses the selected tier's
configured deadline instead — 30 minutes, 90 minutes, or four hours in the
