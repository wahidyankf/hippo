...
- [Architecture specifications](architecture-specifications.md) — the C4 model, kept as-built.
- [Behaviour-driven development](behaviour-driven-development.md) — one corpus, three executing boundaries.
- [Code clarity](code-clarity.md) — phase separation and comment discipline.
