...
var ApprovedExemptions = map[string][]Exemption{
	...
	E2E: {
		...
		{Scenario: "Shared-root contention fails safely after launch and preserves healthy observed work", Boundary: leaseOwnershipBoundary, Reason: "requires a peer holding the shared coordination lock across a guard's activation and sampling, which no compiled binary invocation can arrange"},
