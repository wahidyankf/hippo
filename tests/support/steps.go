...
func (driver *Driver) qualityGateBindings() []contract.StepBinding {
	return []contract.StepBinding{
		...
		step(`^the quick gate and the pull request gate share one documentation check$`, driver.requireSharedDocumentationCheck),
		step(`^the documentation check runs every pinned validator$`, driver.requirePinnedValidatorsRun),
