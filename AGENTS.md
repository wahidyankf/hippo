...
The exit statuses `0`, `1`, `2`, `124`, `125`, `126`, and `127`, the `hippo.area.reason` error codes, the evidence readers, and configuration compatibility are the [public contract](repo-governance/development/public-contract.md); none moves without authorization.
